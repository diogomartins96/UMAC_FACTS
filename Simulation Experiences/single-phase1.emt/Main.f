...
! Single Phase Source: Source1  Type: Ideal
...
! 20:[voltmetergnd] Voltmeter (Line - Ground) 'Ea'
      Ea = EMTDC_VVDC(SS(1), NT_3, 0)

! 30:[fft] On-Line Frequency Scanner 
!
...
! 100:[thd] Harmonic Distortion Calculator 
! Harmonic Distortion
...
! 280:[pgb] Output Channel 'D'

      PGB(IPGB+1) = 1000000.0 * D

! 290:[pgb] Output Channel 'Q'

      PGB(IPGB+2) = 1000000.0 * Q

! 300:[pgb] Output Channel 'PF'

      PGB(IPGB+3) = PF

! 310:[pgb] Output Channel 'P'

      PGB(IPGB+4) = 1000000.0 * P

! 320:[pgb] Output Channel 'S'

      PGB(IPGB+5) = 1000000.0 * S

! 330:[pgb] Output Channel '<Untitled>'

      DO IVD1_1 = 1, 31
         PGB(IPGB+6+IVD1_1-1) = RT_15(IVD1_1)
      ENDDO

! 340:[pgb] Output Channel 'DPF'

      PGB(IPGB+37) = DPF

! 350:[pgb] Output Channel 'Ea'

      PGB(IPGB+38) = 1000.0 * Ea
